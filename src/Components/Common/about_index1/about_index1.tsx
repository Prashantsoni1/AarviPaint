...
const AboutIndex1 = () => {
    const contentData = {
        heading: "ABOUT US",
        paragraph: "Bring color to your life as close to your heart with our range of Color Play",
    }
    return (
        <div className={Styles.main}>
            ...
            <div className={Styles.overlay}> 
                ...
                <div className={Styles.container2}><img src={bucketsgroup} alt="buckets group" className={Styles.bucketImg}/></div>
            </div>
        </div>
    );
};
