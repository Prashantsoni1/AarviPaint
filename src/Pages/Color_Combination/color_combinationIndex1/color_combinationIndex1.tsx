...
const ColorCombinationIndex1 = () => {
    const contentData = {
        ...
        paragraph: "Discover the perfect shades for your space with Aarvi Paints. From bold to subtle tones, explore our high-quality color collection and get inspired to transform your walls.",
    }
  return (
